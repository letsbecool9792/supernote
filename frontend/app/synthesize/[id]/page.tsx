            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <div className="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
                    {isPreview ? (
                        ...
                        <div className="p-6">
                            <div ref={markdownRef} className="prose prose-lg max-w-none overflow-y-auto" style={{ maxHeight: '600px' }}>
                                <ReactMarkdown
                                    components={{
                                        h1: ({...props}) => <h1 className="text-xl font-bold mt-6 mb-3 text-gray-900" {...props} />,
                                        h2: ({...props}) => <h2 className="text-lg font-bold mt-5 mb-2 text-gray-900" {...props} />,
                                        h3: ({...props}) => <h3 className="text-base font-semibold mt-3 mb-2 text-gray-800" {...props} />,
                                        p: ({...props}) => <p className="mb-2 text-sm text-gray-700 leading-relaxed" {...props} />,
                                        ...
                                        blockquote: ({...props}) => <blockquote className="border-l-4 border-indigo-200 pl-4 italic text-sm text-gray-600 my-3" {...props} />,
                                        code: ({...props}) => <code className="bg-gray-100 px-1.5 py-0.5 rounded text-xs font-mono text-gray-800" {...props} />,
                                        pre: ({...props}) => <pre className="bg-gray-100 p-3 rounded-lg overflow-x-auto text-xs font-mono mb-3" {...props} />,
